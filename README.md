...
* **Wrote `HANDOFF.md`:** Full state of the work — measured database facts, the drift result, the ablation table, protocol history, and the gotchas — so a cold session or a future me doesn't have to rediscover any of it.

---

**15 September 2026 | 4:10 pm - 11:45 pm**
**Primary objective:** Build the new model architecture and get it reading from the database

The big day. I rebuilt the whole training pipeline around the database instead of the annotation CSVs on my Desktop, moved everything from PyTorch to TensorFlow/Keras 3.15, and dropped `ALLOWED_PARTICIPANTS` entirely — whoever is in the database is in the study now, so the participant list can't go stale.
...
**14 September 2026 | 1:15 pm - 9:30 pm**
...
**13 September 2026 | 11:00 am - 5:20 pm**
